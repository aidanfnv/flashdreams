...
from clipgt2v.interactive_drive.input.backend import InputBackend, SampledInput
...
class KeyboardState:
    ...
    Implements :class:`~clipgt2v.interactive_drive.runtime.runtime_controls.RuntimeControls`
