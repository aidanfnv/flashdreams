...
from clipgt2v.interactive_drive.colors import (
    BBOX_V3_COLORS,
    HDMAP_V3_COLORS,
    LANE_LINE_STYLE_CONFIG,
)
from clipgt2v.interactive_drive.config import RasterConfig
from clipgt2v.interactive_drive.math3d import (
...
from clipgt2v.interactive_drive.patterns import (
    apply_pattern,
...
from clipgt2v.interactive_drive.ply_io import load_mesh_vf
...
def _load_ground_mesh(
    ...
    :class:`clipgt2v.interactive_drive.simulation.ground_snap.GroundSnapper`, or ``(None, None)`` when the
