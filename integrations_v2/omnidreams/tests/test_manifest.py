...
class WorldModelManifestTest(unittest.TestCase):
    def test_resolves_clipgt2v_bundled_default_manifest(self) -> None:
        path = resolve_world_model_manifest_path("example_world_model.yaml")

        self.assertTrue(path.is_file())
        self.assertEqual(path.name, "example_world_model.yaml")
        self.assertEqual(path.parent.name, "configs")
        self.assertEqual(path.parent.parent.name, "interactive_drive")
